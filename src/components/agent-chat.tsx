...
function ChatMessage({ message, toolSteps, screenshot, onScreenshotClick, avatarProps }: { message: { id: string; role: string; content: string; isStreaming?: boolean; }; toolSteps: ToolStep[]; screenshot: string | null; onScreenshotClick: () => void; avatarProps?: { isThinking?: boolean; isWorking?: boolean } }) {
  ...
  const isThinking = avatarProps?.isThinking ?? false;
  const isWorking = avatarProps?.isWorking ?? false;
    ...
    >
      <div className={`w-8 h-8 rounded-lg flex-shrink-0 flex items-center justify-center ${
        ...
        {isUser ? (
          ...
          <AgentAvatar size="sm" isThinking={isThinking} isWorking={isWorking} />
        )}
      </div>
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border/50">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <AgentAvatar size="sm" isWorking={isAgentRunning} />
            ...
            {!hasMessages ? (
              ...
              <div className="space-y-6">
                {messages.map((msg, i) => {
                  ...
                  const showThinking = isLastAssistant && currentThinking && isAgentRunning;
                  return (
                    <div key={msg.id} className="group">
                      <ChatMessage
                        ...
                        avatarProps={{ isThinking: showThinking, isWorking: isLastAssistant && isAgentRunning }}
                      />
                    </div>
                  );
                })}
